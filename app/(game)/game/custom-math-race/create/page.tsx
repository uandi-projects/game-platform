...
import { Settings, Clock, Hash, Users } from "lucide-react";
import Link from "next/link";

export default function CustomMathRaceCreate() {
  ...
  const handleCreateGame = async () => {
    ...
    try {
      ...
      const instance = await createGameInstance({
        gameId: "custom-math-race",
        customConfig,
      });

      // Redirect to room for multiplayer games
    ...
    <div className="min-h-screen bg-background p-8 flex items-center justify-center">
      <Card className="max-w-lg w-full">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl">Create Custom Math Race</CardTitle>
          <p className="text-muted-foreground">
            Customize your math race settings
          </p>
        </CardHeader>
